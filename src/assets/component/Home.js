...
import bgaboutig from "../img/bg-about-img.png"
import bghero from "../img/bg-hero.png"
import features from "../img/footer.png"
import footer from '../img/footer.png'
import herojpg from '../img/hero-img.jpg'
import heropng from '../img/hero-img.png'
                ...
                <div class="container pt-5">
                    <div class="row g-5 pt-5">
                        ...
                        <div class="col-lg-6 align-self-end text-center text-lg-end">
                            <img class="img-fluid" src={heropng} alt="" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                            <div class="about-img">
                                <img class="img-fluid" src={AboutImg} />
                            </div>
                        </div>
                ...
                <div class="container pt-5">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-6 align-self-end text-center text-md-end wow fadeIn" data-wow-delay="0.5s">
                            <img class="img-fluid" src={features} alt="" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-7 wow fadeIn" data-wow-delay="0.5s">
                            <div class="owl-carousel testimonial-carousel border-start border-primary">
                                ...
                                <div class="testimonial-item ps-5">
                                    ...
                                    <p class="fs-4">Aliqu diam amet diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet</p>
                                    <div class="d-flex align-items-center">
                                        <img class="img-fluid flex-shrink-0 rounded-circle" src={testimonial3}
                                            style={{ width: '60px', height: '60px' }} />
                                        <div class="ps-3">
                                            <h5 class="mb-1">Client Name</h5>
                                            <span>Profession</span>
